...
--
-- The marketplace should list published tools with public metadata only. Hosted runs
-- use the service-role API route to read system_prompt after payment checks.
